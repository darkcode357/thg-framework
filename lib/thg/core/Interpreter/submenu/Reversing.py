...
class ReversingLevel(Cmd):
    colors = "Always"
    console_prompt = "{COLOR_START}Reversing{COLOR_END}".format(COLOR_START=Fore.BLUE, COLOR_END=Fore.YELLOW)
    doc_header = ' Reversing COMMAND HELP'
    doc_leader = ''
    intro = None
    lastcmd = ''
