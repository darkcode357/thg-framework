...
class MiscellaneousLevel(Cmd):
    colors = "Always"
    console_prompt = "{COLOR_START}Miscellaneous{COLOR_END}".format(COLOR_START=Fore.BLUE, COLOR_END=Fore.YELLOW)
    doc_header = ' Miscellaneous COMMAND HELP'
    doc_leader = ''
    intro = None
    lastcmd = ''
