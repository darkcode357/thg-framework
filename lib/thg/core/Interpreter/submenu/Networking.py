...
class NetworkingLevel(Cmd):
    colors = "Always"
    console_prompt = "{COLOR_START}Networking{COLOR_END}".format(COLOR_START=Fore.BLUE, COLOR_END=Fore.YELLOW)
    doc_header = ' Networking COMMAND HELP'
    doc_leader = ''
    intro = None
    lastcmd = ''
