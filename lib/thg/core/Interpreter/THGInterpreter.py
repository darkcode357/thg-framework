...
encode unicode_normalize str encoding['NFC', 'NFKC', 'NFD','NFKD']\n""".format(YELLOW=Fore.YELLOW, BLUE=Fore.BLUE,
    ...
    def _print_modules(self, modules, title):
        self.poutput(title)
        self.poutput(tabulate(modules, tablefmt='grid', headers=(
            Fore.CYAN + 'module_name' + Fore.RESET, Fore.CYAN + 'check' + Fore.RESET,
            Fore.CYAN + 'disclosure_date' + Fore.RESET, Fore.CYAN + 'description' + Fore.RESET)))
