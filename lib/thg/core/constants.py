...
LICENSES         =[THG_LICENSE,GPL_LICENSE,BSD_LICENSE,CORE_LICENSE,ARTISTIC_LICENSE,UNKNOWN_LICENSE]
#
# Module types
#
MODULE_ANY     = '_any_'
...
MODULE_TYPES   = [MODULE_ENCODER,MODULE_PAYLOAD,MODULE_EXPLOIT,MODULE_NOP,MODULE_POST,MODULE_AUX,MODULE_EVASION]
#
# Module rankings
#
ManualRanking       = 0
