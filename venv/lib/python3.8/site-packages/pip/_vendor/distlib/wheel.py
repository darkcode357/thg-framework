...
to_posix = (lambda o: o) if os.sep == "/" else (lambda o: o.replace(os.sep, "/"))
...
class Wheel(object):
    ...
    def unmount(self):
        ...
        if pathname not in sys.path:
            ...
            if not _hook.impure_wheels and _hook in sys.meta_path:
...
def is_compatible(wheel, tags=None):
    ...
    return any(
        ver in wheel.pyver and abi in wheel.abi and arch in wheel.arch
